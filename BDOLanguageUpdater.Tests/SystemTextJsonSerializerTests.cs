...
public sealed class SystemTextJsonSerializerTests
{
    ...
    public void WritableOptions_Update_UpdatesSectionAndPreservesOtherSections()
    {
        ...
        try
        {
            ...
            Assert.True(userPreferences["AutoRepairEnabled"]!.GetValue<bool>());
            Assert.Equal("Friday", userPreferences["AutoRepairDay"]!.GetValue<string>());
