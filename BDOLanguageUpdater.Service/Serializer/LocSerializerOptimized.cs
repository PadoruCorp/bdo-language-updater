...
public static class LocSerializerOptimized
{
    ...
    private static string Decrypt(byte[] buffer)
    {
        ...
        var index = 0;
        var sharedPool = ArrayPool<byte>.Create();
